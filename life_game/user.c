...
void spaceship(frame* frm, pixl_t x, pixl_t y) {
    frame_set(frm, set_point(frm, x + 1, y - 1), LIFE);
    frame_set(frm, set_point(frm, x + 2, y), LIFE);
    frame_set(frm, set_point(frm, x + 2, y + 1), LIFE);
    frame_set(frm, set_point(frm, x + 2, y + 2), LIFE);
    frame_set(frm, set_point(frm, x + 1, y + 2), LIFE);
    frame_set(frm, set_point(frm, x, y + 2), LIFE);
    frame_set(frm, set_point(frm, x - 1, y + 2), LIFE);
    frame_set(frm, set_point(frm, x - 2, y + 1), LIFE);
    frame_set(frm, set_point(frm, x - 2, y - 1), LIFE);
}
